...
var actionName = 'embedded.commerce.return.actions.before';

describe('embedded.commerce.return.actions.before implementing embedded.commerce.return.actions.before', function () {

  var action;

  before(function () {
    action = require('../src/domains/commerce.return/embedded.commerce.return.actions.before');
  });
